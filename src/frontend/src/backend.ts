...
import type { Memory as _Memory, SubmitMemoryResponse as _SubmitMemoryResponse } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async submitMemory(arg0: string, arg1: string | null, arg2: string | null, arg3: string | null): Promise<SubmitMemoryResponse> {
        if (this.processError) {
            try {
                const result = await this.actor.submitMemory(arg0, to_candid_opt_n6(this._uploadFile, this._downloadFile, arg1), to_candid_opt_n6(this._uploadFile, this._downloadFile, arg2), to_candid_opt_n6(this._uploadFile, this._downloadFile, arg3));
                return from_candid_SubmitMemoryResponse_n7(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
...
function from_candid_SubmitMemoryResponse_n7(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _SubmitMemoryResponse): SubmitMemoryResponse {
...
function from_candid_opt_n5(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Memory]): Memory | null {
